...
export default function XMLPretty() {
  ...
  useEffect(() => {
    ...
    addToHistory({
      toolId: 'xml-pretty', toolName: 'XML Pretty', badge: 'XMP',
      categoryName: 'Formateadores',
      description: `Pretty · indent ${indent} · ${outputMeta}`,
    })
  ...
  return (
    <ToolLayout toolId="xml-pretty" actions={indentControl}>
      <SplitPane
        primary={{
          label: 'XML',
          ...
          content: (
            <textarea
              ...
              placeholder='<root><item>valor</item></root>'
              spellCheck={false}
            />
          ),
