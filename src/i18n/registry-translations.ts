...
export const toolI18n: Record<string, Record<Lang, ToolI18n>> = {
  ...
  'img-base64':     { es: { name: 'Img ↔ Base64',    desc: 'Convierte imágenes a Base64 y viceversa'             }, en: { name: 'Img ↔ Base64',    desc: 'Convert images to Base64 and back'                  } },
  'pdf-base64':     { es: { name: 'PDF ↔ Base64',    desc: 'Convierte PDFs a Base64 y viceversa'                 }, en: { name: 'PDF ↔ Base64',    desc: 'Convert PDFs to Base64 and back'                    } },
  'xml-json':       { es: { name: 'XML ↔ JSON',      desc: 'Convierte entre XML y JSON'                          }, en: { name: 'XML ↔ JSON',      desc: 'Convert between XML and JSON'                       } },
